                    ...
                    <Tab.Screen
                        ...
                        children={() => (
                            <HomeScreen
                                ...
                                clearSearchQuery={clearSearchQuery} // Pass clearSearchQuery function to HomeScreen
                            />
                        )}
                        options={{
                            headerShown: false,
...
const HomeScreen = ({ filteredImages, setFilteredImages, handleImagePress, searchQuery, setSearchQuery, handleSearch, clearSearchQuery }) => {
    const renderImages = () => {
        if (searchQuery === '') {
